...
class Todumo extends StatefulWidget {
  const Todumo({super.key});

  @override
  State<Todumo> createState() => _TodumoState();
}

class _TodumoState extends State<Todumo> {
  @override
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                  colors: [
                    Colors.lightGreenAccent, // Start color
